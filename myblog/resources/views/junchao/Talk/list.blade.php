                ...
                <div class="box-body no-padding">
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped" style="table-layout:fixed">
                      <thead>
                        <th class="text-center">文章标题</td>
                        <th class="text-center">分类</td>
                        <th class="text-center">发布时间</td>
                        <th class="text-center">评论</td>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center mailbox-category2">{{ $val->talk->count }}</td>
